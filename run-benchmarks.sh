...
./cmake-build-relwithdebinfo/benchmark/benchmarks/entt-more/ecs-benchmark-entt-more-runtime --benchmark_format=json > ./reports/entt-more-runtime.json
./cmake-build-relwithdebinfo/benchmark/benchmarks/entt-more/ecs-benchmark-entt-more-group --benchmark_format=json > ./reports/entt-more-group.json
