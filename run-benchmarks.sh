...
./cmake-build-relwithdebinfo/benchmark/benchmarks/entitaspp/ecs-benchmark-entitaspp --benchmark_format=json > ./reports/entitaspp.json
...
./cmake-build-relwithdebinfo/benchmark/benchmarks/entitaspp-more/ecs-benchmark-entitaspp-more --benchmark_format=json > ./reports/entitaspp-more.json
