#ifndef ECS_BENCHMARKS_ENTITASPP_MOVEMENTSYSTEM_H_
#define ECS_BENCHMARKS_ENTITASPP_MOVEMENTSYSTEM_H_
...
namespace ecs::benchmarks::EntitasPP::systems {
    ...
    class MovementSystem final
            : public ::EntitasPP::IExecuteSystem, public ::EntitasPP::ISetPoolSystem, public base::systems::MovementSystem<::EntitasPP::Pool, float> {
    public:
        void SetPool(::EntitasPP::Pool* pool) override {
            ...
            m_group = pool->GetGroup(EntitasPP_Matcher_AllOf(EntitasPP::components::PositionComponent, EntitasPP::components::DirectionComponent));
