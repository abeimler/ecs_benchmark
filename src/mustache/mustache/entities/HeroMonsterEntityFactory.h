...
class HeroMonsterEntityFactory final : public ecs::benchmarks::base::entities::HeroMonsterEntityFactory<::mustache::EntityManager, ::mustache::Entity,
...
public:
  ...
  getPlayerComponent(EntityManager& registry, Entity entity) override {
    return *registry.getComponent<ecs::benchmarks::base::components::PlayerComponent,
                                  ::mustache::FunctionSafety::kUnsafe>(entity);
  }

  [[nodiscard]] inline ecs::benchmarks::base::components::HealthComponent&
  getHealthComponent(EntityManager& registry, Entity entity) override {
    return *registry.getComponent<ecs::benchmarks::base::components::HealthComponent,
                                  ::mustache::FunctionSafety::kUnsafe>(entity);
  }

  [[nodiscard]] inline ecs::benchmarks::base::components::DamageComponent&
  getDamageComponent(EntityManager& registry, Entity entity) override {
    return *registry.getComponent<ecs::benchmarks::base::components::DamageComponent,
                                  ::mustache::FunctionSafety::kUnsafe>(entity);
  }
};
