...
BENCHMARK("ginseng     Creating 10M entities", [](benchpress::context* ctx) {
...
BENCHMARK("ginseng     Destroying 10M entities", [](benchpress::context* ctx) {
    GinsengBenchmark::EntityManager db;
...
BENCHMARK("ginseng     Iterating over 10M entities, unpacking one component", [](benchpress::context* ctx) {
    GinsengBenchmark::EntityManager db;
...
BENCHMARK("ginseng     Iterating over 10M entities, unpacking two components", [](benchpress::context* ctx) {
    GinsengBenchmark::EntityManager db;
