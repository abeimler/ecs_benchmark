...
struct FullEntity final : public ::ecs::EntityAlias<ecs::benchmarks::base::components::PositionComponent,
...
struct MinimalEntity final : public ::ecs::EntityAlias<ecs::benchmarks::base::components::PositionComponent,
                                                       ecs::benchmarks::base::components::VelocityComponent> {
  MinimalEntity() {
    add<ecs::benchmarks::base::components::PositionComponent>();
    add<ecs::benchmarks::base::components::VelocityComponent>();
...
struct SingleEntity final : public ::ecs::EntityAlias<ecs::benchmarks::base::components::PositionComponent> {
  SingleEntity() { add<ecs::benchmarks::base::components::PositionComponent>(); }
};
...
public:
  ...
  static auto create(EntityManager& entities) { return entities.create<FullEntity>(); }
  ...
  static auto createMinimal(EntityManager& entities) { return entities.create<MinimalEntity>(); }
  ...
  static auto createEmpty(EntityManager& entities) { return entities.create(); }
  static void createEmptyBulk(EntityManager& entities, size_t nentities) { entities.create(nentities); }
  static auto createSingle(EntityManager& entities) { return entities.create<SingleEntity>(); }
  ...
  getOptionalComponentThree(EntityManager& /*entities*/, Entity& entity) {
    return entity.has<ecs::benchmarks::base::components::DataComponent>()
               ? &entity.get<ecs::benchmarks::base::components::DataComponent>()
               : nullptr;
  }
