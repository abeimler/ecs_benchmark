...
python3 ./scripts/gen-benchmark-report -i ./info.json gen-results-md ./reports/entityx-more.json ./reports/entt-more.json ./reports/ginseng-more.json ./reports/mustache-more.json ./reports/oop-more.json ./reports/openecs-more.json
