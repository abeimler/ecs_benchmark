...
namespace ecs::benchmarks::flecs {
    ...
    public:
        ...
        explicit FlecsBenchmarkSuite(ecs::benchmarks::base::ESCBenchmarkOptions options) : ExtendedECSBenchmark(std::move(options)) {}


        void BM_IterateSingleComponent(benchmark::State& state) {
          using ComponentOne = ecs::benchmarks::base::components::PositionComponent;

          BM_IterateSingleComponentWithPreCreatedView(state,
              [](auto& world) {
        ...
        void BM_IterateTwoComponents(benchmark::State& state) {
          ...
          BM_IterateTwoComponentsWithPreCreatedView(state,
              [](auto& world) {
        ...
        void BM_IterateThreeComponentsWithMixedEntities(benchmark::State& state) {
          ...
          BM_IterateThreeComponentsWithMixedEntitiesAndPreCreatedView(state,
              [](auto& world) {
