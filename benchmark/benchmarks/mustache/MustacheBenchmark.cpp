...
BENCHMARK(BM_mustache_CreateEntities)
    ->Arg(10)
    ->Arg(25)
    ->Arg(50)
    ->Arg(100)
...
BENCHMARK(BM_mustache_DestroyEntities)
        ->Arg(10)
        ->Arg(25)
        ->Arg(50)
        ->Arg(100)
...
BENCHMARK(BM_mustache_UnpackOneComponent)
        ->Arg(10)
        ->Arg(25)
        ->Arg(50)
        ->Arg(100)
...
BENCHMARK(BM_mustache_UnpackTwoComponents)
        ->Arg(10)
        ->Arg(25)
        ->Arg(50)
        ->Arg(100)
...
BENCHMARK(BM_mustache_UnpackTwoComponentsFromMixedEntities)
        ->Arg(10)
        ->Arg(25)
        ->Arg(50)
        ->Arg(100)
...
BENCHMARK(BM_mustache_UnpackThreeComponentsFromMixedEntities)
        ->Arg(10)
        ->Arg(25)
        ->Arg(50)
        ->Arg(100)
...
BENCHMARK(BM_mustache_SystemsUpdate)
        ->Arg(10)
        ->Arg(25)
        ->Arg(50)
        ->Arg(100)
