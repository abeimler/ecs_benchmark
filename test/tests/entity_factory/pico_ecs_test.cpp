...
TEMPLATE_TEST_CASE_METHOD(ecs::benchmarks::EntityFactory_Fixture, "Test EntityFactory for pico_ecs",
                          "[template][pico_ecs][entity_factory]", ecs::benchmarks::pico_ecs::entities::EntityFactory) {
  GIVEN("EntityFactory") {
